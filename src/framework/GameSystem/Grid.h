...
class MANGOS_DLL_DECL Grid
{
    ...
    public:
        ...
        */
         ...
         */
        template<class T, class V> void Visit(TypeContainerVisitor<T, TypeMapContainer<GRID_OBJECT_TYPES>, V > &visitor)
        {
         ...
         */
        template<class T, class V> void Visit(TypeContainerVisitor<T, TypeMapContainer<WORLD_OBJECT_TYPES>, V > &visitor)
        {
