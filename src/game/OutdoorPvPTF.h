...
const go_type TFCapturePoints[TF_TOWER_NUM] = {
    {183104, -3081.65f, 5335.03f, 17.1853f, -2.14675f,  0.0f, 0.0f,      0.878817f, -0.477159f},
    {183411, -2939.9f,  4788.73f, 18.987f,   2.77507f,  0.0f, 0.0f,      0.983255f, 0.182236f},
    {183412, -3174.94f, 4440.97f, 16.2281f,  1.86750f,  0.0f, 0.803857f, 0.594823f},
    {183413, -3603.31f, 4529.15f, 20.9077f,  0.994838f, 0.0f, 0.0f,      0.477159f, 0.878817f},
    {183414, -3812.37f, 4899.3f,  17.7249f,  0.087266f, 0.0f, 0.0f,      0.043619f, 0.999048f}
};
