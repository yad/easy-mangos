...
enum eConfigInt32Values
{
    ...
    CONFIG_INT32_MAX_BOT_IN_ZONE_BY_PLAYER,
    CONFIG_INT32_MAX_BOT_IN_GM_ISLAND_BY_FACTION,
    CONFIG_INT32_MAX_BOT_ALLIANCE_SIDE,
    CONFIG_INT32_MAX_BOT_HORDE_SIDE,
...
enum eConfigFloatValues
{
    ...
    CONFIG_FLOAT_RATE_CHARRUNSPEED,
    CONFIG_FLOAT_RATE_CHARSWIMSPEED,
    CONFIG_FLOAT_RATE_CHARFLIGHTSPEED,
...
enum eConfigBoolValues
{
    ...
    CONFIG_BOOL_UNLIMITED_INDISPENDABLE_ITEMS,
    CONFIG_BOOL_LEARN_SPELLS_AT_LEVEL_UP,
    CONFIG_BOOL_MMAP_ENABLED,
    CONFIG_BOOL_BOTS_ENABLED,
