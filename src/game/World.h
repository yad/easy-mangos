...
enum eConfigBoolValues
{
    ...
    CONFIG_BOOL_ARENA_SEASON_ID,
    CONFIG_BOOL_ARENA_SEASON_IN_PROGRESS,
    CONFIG_BOOL_OFFHAND_CHECK_AT_TALENTS_RESET,
    CONFIG_BOOL_CLIENTCACHE_VERSION,
    CONFIG_BOOL_GUILD_EVENT_LOG_COUNT,
    CONFIG_BOOL_GUILD_BANK_EVENT_LOG_COUNT,
    CONFIG_BOOL_TIMERBAR_FATIGUE_GMLEVEL,
    CONFIG_BOOL_TIMERBAR_FATIGUE_MAX,
    CONFIG_BOOL_TIMERBAR_BREATH_GMLEVEL,
    CONFIG_BOOL_TIMERBAR_BREATH_MAX,
    CONFIG_BOOL_TIMERBAR_FIRE_GMLEVEL,
    CONFIG_BOOL_TIMERBAR_FIRE_MAX,
    //
    CONFIG_BOOL_RATE_HEALTH,
    CONFIG_BOOL_RATE_POWER_MANA,
    CONFIG_BOOL_RATE_POWER_RAGE_INCOME,
    CONFIG_BOOL_RATE_POWER_RAGE_LOSS,
    CONFIG_BOOL_RATE_POWER_RUNICPOWER_INCOME,
    CONFIG_BOOL_RATE_POWER_RUNICPOWER_LOSS,
    CONFIG_BOOL_RATE_POWER_FOCUS,
    CONFIG_BOOL_RATE_SKILL_DISCOVERY,
    CONFIG_BOOL_RATE_DROP_ITEM_POOR,
    CONFIG_BOOL_RATE_DROP_ITEM_NORMAL,
    CONFIG_BOOL_RATE_DROP_ITEM_UNCOMMON,
    CONFIG_BOOL_RATE_DROP_ITEM_RARE,
    CONFIG_BOOL_RATE_DROP_ITEM_EPIC,
    CONFIG_BOOL_RATE_DROP_ITEM_LEGENDARY,
    CONFIG_BOOL_RATE_DROP_ITEM_ARTIFACT,
    CONFIG_BOOL_RATE_DROP_ITEM_REFERENCED,
    CONFIG_BOOL_RATE_DROP_MONEY,
    CONFIG_BOOL_RATE_XP_KILL,
    CONFIG_BOOL_RATE_XP_QUEST,
    CONFIG_BOOL_RATE_XP_EXPLORE,
    CONFIG_BOOL_RATE_REPUTATION_GAIN,
    CONFIG_BOOL_RATE_REPUTATION_LOWLEVEL_KILL,
    CONFIG_BOOL_RATE_REPUTATION_LOWLEVEL_QUEST,
    CONFIG_BOOL_RATE_CREATURE_NORMAL_HP,
    CONFIG_BOOL_RATE_CREATURE_ELITE_ELITE_HP,
    CONFIG_BOOL_RATE_CREATURE_ELITE_RAREELITE_HP,
    CONFIG_BOOL_RATE_CREATURE_ELITE_WORLDBOSS_HP,
    CONFIG_BOOL_RATE_CREATURE_ELITE_RARE_HP,
    CONFIG_BOOL_RATE_CREATURE_NORMAL_DAMAGE,
    CONFIG_BOOL_RATE_CREATURE_ELITE_ELITE_DAMAGE,
    CONFIG_BOOL_RATE_CREATURE_ELITE_RAREELITE_DAMAGE,
    CONFIG_BOOL_RATE_CREATURE_ELITE_WORLDBOSS_DAMAGE,
    CONFIG_BOOL_RATE_CREATURE_ELITE_RARE_DAMAGE,
    CONFIG_BOOL_RATE_CREATURE_NORMAL_SPELLDAMAGE,
    CONFIG_BOOL_RATE_CREATURE_ELITE_ELITE_SPELLDAMAGE,
    CONFIG_BOOL_RATE_CREATURE_ELITE_RAREELITE_SPELLDAMAGE,
    CONFIG_BOOL_RATE_CREATURE_ELITE_WORLDBOSS_SPELLDAMAGE,
    CONFIG_BOOL_RATE_CREATURE_ELITE_RARE_SPELLDAMAGE,
    CONFIG_BOOL_RATE_CREATURE_AGGRO,
    CONFIG_BOOL_RATE_REST_INGAME,
    CONFIG_BOOL_RATE_REST_OFFLINE_IN_TAVERN_OR_CITY,
    CONFIG_BOOL_RATE_REST_OFFLINE_IN_WILDERNESS,
    CONFIG_BOOL_RATE_DAMAGE_FALL,
    CONFIG_BOOL_RATE_AUCTION_TIME,
    CONFIG_BOOL_RATE_AUCTION_DEPOSIT,
    CONFIG_BOOL_RATE_AUCTION_CUT,
    CONFIG_BOOL_RATE_HONOR,
    CONFIG_BOOL_RATE_MINING_AMOUNT,
    CONFIG_BOOL_RATE_MINING_NEXT,
    CONFIG_BOOL_RATE_TALENT,
    CONFIG_BOOL_RATE_CORPSE_DECAY_LOOTED,
    CONFIG_BOOL_RATE_INSTANCE_RESET_TIME,
    CONFIG_BOOL_RATE_TARGET_POS_RECALCULATION_RANGE,
    CONFIG_BOOL_RATE_DURABILITY_LOSS_DAMAGE,
    CONFIG_BOOL_RATE_DURABILITY_LOSS_PARRY,
    CONFIG_BOOL_RATE_DURABILITY_LOSS_ABSORB,
    CONFIG_BOOL_RATE_DURABILITY_LOSS_BLOCK,
    CONFIG_BOOL_SIGHT_GUARDER,
    CONFIG_BOOL_SIGHT_MONSTER,
    CONFIG_BOOL_LISTEN_RANGE_SAY,
    CONFIG_BOOL_LISTEN_RANGE_YELL,
    CONFIG_BOOL_LISTEN_RANGE_TEXTEMOTE,
