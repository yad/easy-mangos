...
ChatCommand * ChatHandler::getCommandTable()
{
    ...
    static ChatCommand learnCommandTable[] =
    {
        ...
        { "all_myspellslevel",    SEC_ADMINISTRATOR,  false, &ChatHandler::HandleLearnAllMySpellsForMyLevelCommand,     "", NULL },
        { "all_mytalentslevel",   SEC_ADMINISTRATOR,  false, &ChatHandler::HandleLearnAllMyTalentsForMyLevelCommand,    "", NULL },
