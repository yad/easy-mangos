...
void PlayerbotMageAI::DoNextCombatManeuver(Unit *pTarget)
{
    ...
    //Brûlure > Givrefeu > Trait de feu > Brûlure > Fireball > Choc de flammes >  Brûlure > Fireball > Vague explosive > Brûlure > Pyro > Brûlure > Fireball > Bombevivante > Soufle du dragon
    //Givrefeu > Eclair de Givre > Eclair de Givre > Javelot de Glace > Eclair de Givre > Eclair de Givre > Cône de froid > Eclair de Givre > Eclair de Givre > Javelot de Glace > Nova de Givre > Blizzard
    //Projectile des arcanes > Déflagration des arcanes x 4 > Projectile des arcanes > Barrage des arcanes
