...
Unit(), i_AI(NULL), GridCreature(this),
            ...
            if(GetCreatureInfo()->trainer_race && pPlayer->getRace() != GetCreatureInfo()->trainer_race)
            {
                if(msg)
                {
                    ...
                    switch(GetCreatureInfo()->trainer_class)
                    {
                        ...
                        case RACE_GOBLIN:       pPlayer->PlayerTalkClass->SendGossipMenu(5861,GetGUID()); break;
                        ...
                        case RACE_FEL_ORC:      pPlayer->PlayerTalkClass->SendGossipMenu(5863,GetGUID()); break;
                    }
                }
                return false;
            }
