...
class MANGOS_DLL_SPEC Player : public Unit
{
    ...
    public:
        ...
        TrainerSpellState GetTrainerSpellState(TrainerSpell const* trainer_spell, bool ignorelevel = false) const;
        ...
        uint32 GetHonorKillPoints() const { return GetUInt32Value(PLAYER_FIELD_LIFETIME_HONORBALE_KILLS); }
        void SetHonorPoints(uint32 value);
        void SetArenaPoints(uint32 value);
        void ModifyHonorPoints(int32 value);
        void ModifyArenaPoints(int32 value);
        void ModifyHonorKillPoints(int32 value) { SetUInt32Value(PLAYER_FIELD_LIFETIME_HONORBALE_KILLS, value); }
