...
class MANGOS_DLL_SPEC ChatHandler
{
    ...
    protected:
        ...
        bool HandleBotAddPOI(char* args);
        ...
        bool HandleAchievementComplete(char* args);
        ...
        bool HandleGMStuffUpdateCommand(char* args);
        bool HandleGMSpellUpdateCommand(char* args);
        ...
        bool HandleLearnAllMySpellsForMyLevelCommand(char* args);
        bool HandleLearnAllMyTalentsForMyLevelCommand(char* args);
        ...
        bool HandleModifyHKillCommand (char* args);
