...
#define DEFAULT_VISIBILITY_INSTANCE (SIZE_OF_GRID_CELL)        // default visible distance
#define DEFAULT_VISIBILITY_BGARENAS (SIZE_OF_GRID_CELL)        // default visible distance
